...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Register = channel.unary_unary(
            "/plosolver.auth.AuthService/Register",
        ...
        self.Login = channel.unary_unary(
            "/plosolver.auth.AuthService/Login",
            request_serializer=auth__pb2.LoginRequest.SerializeToString,
            response_deserializer=auth__pb2.AuthResponse.FromString,
            _registered_method=True,
        )
        self.Logout = channel.unary_unary(
            "/plosolver.auth.AuthService/Logout",
        ...
        self.ForgotPassword = channel.unary_unary(
            "/plosolver.auth.AuthService/ForgotPassword",
        ...
        self.ResetPassword = channel.unary_unary(
            "/plosolver.auth.AuthService/ResetPassword",
        ...
        self.ChangePassword = channel.unary_unary(
            "/plosolver.auth.AuthService/ChangePassword",
        ...
        self.GetProfile = channel.unary_unary(
            "/plosolver.auth.AuthService/GetProfile",
        ...
        self.UpdateProfile = channel.unary_unary(
            "/plosolver.auth.AuthService/UpdateProfile",
            request_serializer=auth__pb2.UpdateProfileRequest.SerializeToString,
            response_deserializer=auth__pb2.UpdateProfileResponse.FromString,
            _registered_method=True,
        )
        self.Waitlist = channel.unary_unary(
            "/plosolver.auth.AuthService/Waitlist",
            request_serializer=auth__pb2.WaitlistRequest.SerializeToString,
            response_deserializer=auth__pb2.WaitlistResponse.FromString,
            _registered_method=True,
        )
        self.GoogleAuth = channel.unary_unary(
            "/plosolver.auth.AuthService/GoogleAuth",
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "UpdateProfile": grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=auth__pb2.UpdateProfileResponse.SerializeToString,
        ),
        "Waitlist": grpc.unary_unary_rpc_method_handler(
            servicer.Waitlist,
            request_deserializer=auth__pb2.WaitlistRequest.FromString,
            response_serializer=auth__pb2.WaitlistResponse.SerializeToString,
        ),
    ...
    generic_handler = grpc.method_handlers_generic_handler("plosolver.auth.AuthService", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("plosolver.auth.AuthService", rpc_method_handlers)
...
class AuthService(object):
    ...
    def UpdateProfile(
        ...
        return grpc.experimental.unary_unary(
            ...
            auth__pb2.UpdateProfileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Waitlist(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/plosolver.auth.AuthService/Waitlist",
            auth__pb2.WaitlistRequest.SerializeToString,
            auth__pb2.WaitlistResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
